...
async def download_pdf(recommendation_id: int, db: Session = Depends(get_db)):
    ...
    farmer_dict = {
        ...
        'state': farmer.state, 'field_area': farmer.field_area,
        'crop_name': farmer.crop_name, 'crop_season': farmer.crop_season.value
    }
    
    soil_dict = {
        'nitrogen': soil_data.nitrogen, 'phosphorus': soil_data.phosphorus,
        'potassium': soil_data.potassium, 'ph': soil_data.ph,
        'ec': soil_data.ec, 'moisture': soil_data.moisture,
        'organic_carbon': soil_data.organic_carbon, 'sample_id': soil_data.sample_id
    }
    ...
    recommendation_dict = {
        ...
        'additional_data': recommendation.reasoning
    }
